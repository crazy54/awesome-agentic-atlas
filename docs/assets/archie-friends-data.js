...
export const FRIENDS = {
  ...
  quack: {
    ...
    lines: {
      ...
      // `debug-archie-2[i]` is the moment he hears himself and finds it. Keep the two the same length.
      "debug-archie": [["Well, the loop runs once for every item, and then it stops at the last..."],
                       ["So I read the config, and the config says 'recieve'..."],
                       ["I didn't change anything, it just broke. Well, except one tiny thing..."],
                       ["The tests all pass, so it must work. The tests do run, of course..."],
                       ["It can't be the cache. I cleared it last... month..."],
                       ["It works on my machine, because my machine has the right version of..."],
                       ["The page loads, then the script loads, then the script looks for the page..."],
                       ["I named the variable data, and the other one data2, and the other one..."]],
      "debug-archie-2": [["...oh. Off by one. Thanks, Quack."], ["...a typo. It was a typo.", 1],
                         ["...which was the whole thing. Right."], ["...don't they. Oh no. They don't."],
                         ["...It's the cache, isn't it."], ["...everything. Nobody else has it. Oh."],
                         ["...which isn't there yet. Race condition. Of course."],
                         ["...data. It's reading the wrong data. Thank you, Quack."]],
